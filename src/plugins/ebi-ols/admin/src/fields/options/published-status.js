  ...
  options: [
    {
      ...
      metadatas: {
        intlLabel: {
          id: getTrad(`custom-fields.ncbitaxon.options.advanced.published_status.published`),
    ...
    },
    {
      ...
      metadatas: {
        intlLabel: {
          id: getTrad(`custom-fields.ncbitaxon.options.advanced.published_status.unpublished`),
    ...
    },
    {
      ...
      metadatas: {
        intlLabel: {
          id: getTrad(`custom-fields.ncbitaxon.options.advanced.published_status.any`),
          defaultMessage: 'Any',
        },
      },
    },
